...
class CategoryImageService extends TransactionBaseService {
  ...
  async create(
    data: Pick<CategoryImage, "category_id" | "categorythumbnail" | "navimage" | "avg_price" | "avg_delivery_time" | "order_frequency" > // Data for the new CategoryImage item
    ...
    return this.atomicPhase_(async (manager) => {
      ...
      categoryImage.avg_price = data.avg_price
      categoryImage.avg_delivery_time = data.avg_delivery_time
      categoryImage.order_frequency = data.order_frequency
